 ...
 */
- (NSArray *)routeTurningPointsAsGPSPointsForRouteWithId:(int)routeId;

/** Returns the array of turning points as GPS points for the current route.
 @return The array of route coordinates ( CLLocation objects ).
 */
- (NSArray *)routeTurningPointsAsGPSPoints;
...
/**
 ...
 @return The array of route coordinates ( CLLocation objects ).
 */
- (NSArray *)routeTurningPointsAsMercatorPointsForRouteWithId:(int)routeId;

/** Returns the array of turning points as Mercator points for the current route.
 @return The array of route coordinates (CLLocation objects ).
 */
- (NSArray *)routeTurningPointsAsMercatorPoints;
